    ...
    <div className='min-h-screen bg-light'>
      ...
      <header className='border-b border-blue-dark border-opacity-15 py-4 px-5 md:px-10'>
        <div className='max-w-7xl mx-auto flex items-center justify-between'>
          ...
          <Link
            href='/'
            className='text-darkBlue hover:text-redd transition-colors font-neue-roman text-sm md:text-base'
          >
            ← Back to Home
          </Link>
        </div>
      ...
      <div className='py-20 px-5 md:px-10'>
        <div className='max-w-4xl mx-auto'>
          {/* Header */}
          <div className='mb-12'>
            <h1 className='text-darkBlue text-4xl md:text-5xl lg:text-6xl font-bold font-denton uppercase mb-4'>
              Privacy Policy
            </h1>
            <p className='text-darkBlue text-lg font-neue-roman font-light'>
          ...
          {/* Introduction */}
          <div className='mb-10'>
            <p className='text-darkBlue text-base md:text-lg font-neue-roman font-light leading-relaxed mb-4'>
            ...
            <p className='text-darkBlue text-base md:text-lg font-neue-roman font-light leading-relaxed'>
          ...
          <div className='mb-10 p-4 rounded-lg border-2 border-blue-dark border-opacity-15'>
            <p className='text-darkBlue text-sm font-neue-roman font-medium'>
              <strong>This policy is effective as of:</strong> 11/14/2025
            </p>
            <p className='text-darkBlue text-sm font-neue-roman font-medium mt-2'>
          ...
          <section className='mb-10'>
            <h2 className='text-darkBlue text-2xl md:text-3xl font-bold font-denton uppercase mb-6'>
              Information We Collect
            </h2>
            <p className='text-darkBlue text-base md:text-lg font-neue-roman font-light leading-relaxed mb-6'>
              We collect information in two main categories:
            </p>

            <div className='mb-6'>
              <h3 className='text-darkBlue text-xl md:text-2xl font-bold font-denton uppercase mb-4'>
            ...
            <div className='mb-6'>
              ...
              <ul className='list-disc list-inside text-darkBlue text-base md:text-lg font-neue-roman font-light leading-relaxed space-y-2 ml-4'>
                <li>IP address</li>
              ...
              <p className='text-darkBlue text-base md:text-lg font-neue-roman font-light leading-relaxed mt-4'>
          ...
          <section className='mb-10 p-6 rounded-lg border-2 border-blue-dark border-opacity-15'>
            ...
            <div className='space-y-3 text-darkBlue text-base md:text-lg font-neue-roman font-light'>
              <p>
                <strong>Email:</strong>{' '}
                <a
              ...
              <p className='text-darkBlue text-base md:text-lg font-neue-roman font-light'>
